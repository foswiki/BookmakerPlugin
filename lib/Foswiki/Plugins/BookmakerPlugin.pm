...
sub initPlugin {
    ...
    Foswiki::Func::registerTagHandler( 'BOOKMAKER_IN_OPEN_BOOK', \&_IN_OPEN_BOOK );
	...
	my ($tweb, $ttopic) = Foswiki::Func::normalizeWebTopicName(
	    $web, Foswiki::Func::getCgiQuery()->param('open_bookmaker'));
	$ttopic = "WebOrder" if $ttopic eq "WebHome";
	$tweb = Foswiki::Sandbox::untaint($tweb, \&Foswiki::Sandbox::validateWebName);
	...
	'Bookmaker', 'Foswiki::Plugins::BookmakerPlugin::JQuery');
